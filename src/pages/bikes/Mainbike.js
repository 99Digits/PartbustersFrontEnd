...
import MyVerticallyCenteredModal from '../cars/MyVerticallyCenteredModal';
import Scrool_indicator from '../../component/scrool_indicator/Scrool_indicator';
import Footer from '../../component/footer/Footer';
import Topbikes from './otherdatabike/Topbikes';
          ...
          <div className="col-lg-5 col-md-4 col-sm-12 col-xs-12 searchcar">
            ...
            >
              ...
              <Card.Body>
                <Card.Title>
                  <div>
                  <i class="fa-solid fa-motorcycle cardcartitle"></i>
                
                    <i class="fa-solid fa-magnifying-glass cardcartitle"></i>
                    &nbsp;
                    <span className="selectcar-title">
                      <strong>
                        SELECT YOUR BIKE TO SEARCH FOR PARTS &nbsp;
                ...
                <p className="mt-4 byregnumber">
                  <i class="fa-solid fa-motorcycle" style={{ color: "blue" }}></i>{" "}
                ...
                >
                  {" "}
                  CAN’T FIND YOUR BIKE IN THE CATALOGUE?
                </a>
              </Card.Body>
            </Card>
          </div>
            ...
            <Carousel>
              <Carousel.Item interval={1000}>
                <img
                  ...
                  src="https://www.bennetts.co.uk/-/media/bikesocial/2019-october-images/top-ten-best-selling-bikes-2019/top-ten-best-selling-bikes-2019-(3).ashx?h=493&la=en&w=740&hash=3BD88B920ADE49DAF38D8E18F94F1AAA7A9018F7"
                  alt="First slide"
                />
              ...
              <Carousel.Item interval={1500}>
                <img
                  className="d-block w-100"
                  src="https://www.bennetts.co.uk/-/media/bikesocial/2019-october-images/top-ten-best-selling-bikes-2019/top-ten-best-selling-bikes-2019-(4).ashx?h=493&la=en&w=740&hash=22801C3FDB41CFD5B5EA813264C402CF30521ADA"
                  alt="Second slide"
                />
              ...
              <Carousel.Item interval={1000}>
                <img
                  className="d-block w-100"
                  src="https://www.bennetts.co.uk/-/media/bikesocial/2019-october-images/top-ten-best-selling-bikes-2019/top-ten-best-selling-bikes-2019-(7).ashx?h=493&la=en&w=740&hash=B8CD3E3A3005D2E0E370023D8F069425511FF3F4"
                  alt="Third slide"
                />
              ...
              <Carousel.Item interval={1000}>
                <img
                  className="d-block w-100"
                  src="https://www.bennetts.co.uk/-/media/bikesocial/2019-october-images/top-ten-best-selling-bikes-2019/top-ten-best-selling-bikes-2019-(9).ashx?h=493&la=en&w=740&hash=E5ED4923A1D9E963DDD841E573658D6AD8356619"
                  alt="Third slide"
                />
              ...
              <Carousel.Item interval={1000}>
                <img
                  className="d-block w-100"
                  src="https://www.bennetts.co.uk/-/media/bikesocial/2019-october-images/top-ten-best-selling-bikes-2019/top-ten-best-selling-bikes-2019-(2).ashx?h=493&la=en&w=740&hash=C86708D479AE845469F6305391B660DFC7FBF63F"
                  alt="Third slide"
                />
              ...
              <Carousel.Item interval={1000}>
                <img
                  className="d-block w-100"
                  src="https://www.royalenfield.com/content/dam/royal-enfield/hntr-350/home/motorcycle/motorcycle-landing.jpg"
                />
                <Carousel.Caption>
              ...
              <Carousel.Item interval={1000}>
                <img
                  className="d-block w-100"
                  src="https://cdni.autocarindia.com/Utils/ImageResizer.ashx?n=https://cdni.autocarindia.com/ExtraImages/20230320044023_SDR%203.jpg"
                  alt="First slide"
                />
